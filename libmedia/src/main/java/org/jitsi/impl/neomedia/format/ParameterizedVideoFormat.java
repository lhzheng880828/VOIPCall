    ...
    extends VideoFormat
{
    ...
    {
        super(encoding, size == null? null:new Dimension(size.width,size.height), maxDataLength, dataType, frameRate);
    ...
    public Object clone()
    {
        ParameterizedVideoFormat f
            = new ParameterizedVideoFormat(
                    getEncoding(),
                getSize() == null ? null: new Dimension(getSize().width, getSize().height),
                    getMaxDataLength(),
                    getDataType(),
                    getFrameRate(),
                    /*
