    ...
    implements RTCPFeedbackCreateListener
{
     ...
     */
    private static java.awt.Component getVisualComponent(Player player)
    {
            ...
            boolean hflip)
    {
        ...
        else if (ev instanceof RealizeCompleteEvent)
        {
            ...
            Component visualComponent = null;//player.getVisualComponent();
            boolean start;
    ...
    protected Component createLocalVisualComponent()
    {
         ...
         */
        java.awt.Component localVisualComponent;
            ...
            ComponentEvent ev)
    {
        ...
        int width = visualComponent.getSize()!=null?visualComponent.getSize().width:0;
        int height = visualComponent.getSize()!=null?visualComponent.getSize().height:0;


        Dimension outputSize = new Dimension(width,height );
        float outputWidth = outputSize!=null?outputSize.width:0;
        float outputHeight = outputSize!=null?outputSize.height:0;
            ...
            MediaFormatImpl<? extends Format> mediaFormat)
    {
                ...
                && (outputSize.height > 0))
        {
            ...
            {
                videoFormatSize = new Dimension(outputSize.width, outputSize.height);
            }
            else
            {
            ...
            Format format)
    {
        ...
        if (outputSize != null)
        {
            ...
            scaler.setOutputSize(new Dimension(outputSize.width, outputSize.height));
            codecCount++;
        }
