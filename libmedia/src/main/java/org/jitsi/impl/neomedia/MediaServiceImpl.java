    ...
    implements MediaService
{
            ...
            int preferredWidth, int preferredHeight)
    {
        ...
        //del for android compile
        //noPreview.setHorizontalAlignment(SwingConstants.CENTER);
        //noPreview.setVerticalAlignment(SwingConstants.CENTER);

        final JComponent videoContainer = null;
            ...
            VideoContainerHierarchyListener listener)
    {
        ...
        else if (event instanceof RealizeCompleteEvent)
        {
            ...
            //for Android complile
            Component video = null;//player.getVisualComponent();
            ...
            int width, int height, int x, int y)
    {
        ...
        Format formats[] = new Format[]
                            {
                                   new AVFrameFormat(
                                        new java.awt.Dimension(size.width,size.height), //size
