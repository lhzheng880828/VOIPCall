...
public class VideoNotifierSupport
{
     ...
     * otherwise, <tt>false</tt>
     */
    //visualComponent - > JAWTRendererAndroidComponent
    //调用栈信息
    /*MediaDeviceSession$ControllerListener.controllerUpdate
        VideoMediaDeviceSession.playerControllerUpdate
            MediaDeviceSession.playerControllerUpdate
                VideoMediaDeviceSession.playerRealizeComplete
                    VideoMediaDeviceSession.fireVideoEvent
					    VideoNotifierSupport.fireVideoEvent(4 params)
					*/
    ...
    {
        try {
            throw new Exception("fireVideoEvent Call Stack Trace");
        } catch (Exception e) {
            Log.i("lhzheng@grandstream.com", "fireVideoEvent", e);
        }
