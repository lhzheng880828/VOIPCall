...
public class ConfigurationUtils
{
    ...
    private  static String PNAME_IS_RECENT_MESSAGES_DISABLED = "net.java.sip.communicator.service.msghistory.IS_RECENT_MESSAGES_DISABLED";
    ...
    {
        return defaultFontColor == -1 ? null : new Color();
    }
