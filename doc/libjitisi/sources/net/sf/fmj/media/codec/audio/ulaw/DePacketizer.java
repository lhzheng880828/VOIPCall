...
public class DePacketizer extends AbstractDePacketizer {
    ...
    public DePacketizer() {
        ...
        formatArr[0] = new AudioFormat(AudioFormat.ULAW, -1.0d, -1, -1, -1, -1, -1, -1.0d, Format.byteArray);
        this.outputFormats = formatArr;
        formatArr = new Format[1];
        formatArr[0] = new AudioFormat(AudioFormat.ULAW_RTP, -1.0d, -1, -1, -1, -1, -1, -1.0d, Format.byteArray);
    ...
    public Format[] getSupportedOutputFormats(Format input) {
        ...
        if (input instanceof AudioFormat) {
            ...
            if (inputCast.getEncoding().equals(AudioFormat.ULAW_RTP)) {
                AudioFormat result = new AudioFormat(AudioFormat.ULAW, inputCast.getSampleRate(), inputCast.getSampleSizeInBits(), inputCast.getChannels(), inputCast.getEndian(), inputCast.getSigned(), inputCast.getFrameSizeInBits(), inputCast.getFrameRate(), inputCast.getDataType());
