...
import org.jitsi.bouncycastle.asn1.cmp.InfoTypeAndValue;
...
import org.jitsi.bouncycastle.asn1.cmp.PKIHeaderBuilder;
...
public class ProtectedPKIMessageBuilder {
    ...
    private ProtectedPKIMessage finaliseMessage(PKIHeader pKIHeader, DERBitString dERBitString) {
        ...
        while (true) {
            ...
            cMPCertificateArr[i2] = new CMPCertificate(((X509CertificateHolder) this.extraCerts.get(i2)).toASN1Structure());
            i = i2 + 1;
        }
    }
