...
public class RosterPacket extends IQ {
    ...
    public static class Item {
        ...
        public String toXML() {
            ...
            buf.append("<item jid=\"").append(this.user).append(Separators.DOUBLE_QUOTE);
            if (this.name != null) {
                buf.append(" name=\"").append(StringUtils.escapeForXML(this.name)).append(Separators.DOUBLE_QUOTE);
            }
            if (this.itemType != null) {
                buf.append(" subscription=\"").append(this.itemType).append(Separators.DOUBLE_QUOTE);
            }
            if (this.itemStatus != null) {
                buf.append(" ask=\"").append(this.itemStatus).append(Separators.DOUBLE_QUOTE);
            }
