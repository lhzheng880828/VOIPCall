...
public class PrivacyListManager {
    ...
    static {
        Connection.addConnectionCreationListener(new ConnectionCreationListener() {
            public void connectionCreated(Connection connection) {
                PrivacyListManager privacyListManager = new PrivacyListManager(connection);
            }
        });
    }
    ...
    private PrivacyListManager(Connection connection) {
        ...
        this.packetFilter = new AndFilter(new IQTypeFilter(Type.SET), new PacketExtensionFilter(JingleInfoQueryIQ.ELEMENT_NAME, "jabber:iq:privacy"));
