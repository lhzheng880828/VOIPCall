...
public class StringUtils {
    ...
    public static Date parseXEP0082Date(String dateString) throws ParseException {
        ...
        synchronized (XEP_0082_UTC_FORMAT) {
            parse = XEP_0082_UTC_FORMAT.parse(dateString);
        }
        return parse;
    }
    ...
    public static String formatXEP0082Date(Date date) {
        String format;
        synchronized (XEP_0082_UTC_FORMAT) {
            format = XEP_0082_UTC_FORMAT.format(date);
        }
        return format;
    }
    ...
    public static String parseName(String XMPPAddress) {
        ...
        int atIndex = XMPPAddress.lastIndexOf(Separators.AT);
        if (atIndex <= 0) {
            return "";
        }
    ...
    public static String parseServer(String XMPPAddress) {
        ...
        int slashIndex = XMPPAddress.indexOf(Separators.SLASH);
    ...
    public static String encodeHex(byte[] bytes) {
        ...
        for (byte aByte : bytes) {
            if ((aByte & 255) < 16) {
                hex.append(SdpConstants.RESERVED);
            }
