...
public class LiteDebugger implements SmackDebugger {
    ...
    private void createDebug() {
        this.frame = new JFrame("Smack Debug Window -- " + this.connection.getServiceName() + Separators.COLON + this.connection.getPort());
        ...
        this.frame.setSize(550, Response.BAD_REQUEST);
        ...
        this.readerListener = new ReaderListener() {
            public void read(String str) {
                ...
                if (index != -1) {
                    ...
                    receivedText1.append("\n");
                    receivedText2.append("\n");
                    if (str.length() > index) {
        ...
        this.listener = new PacketListener() {
            public void processPacket(Packet packet) {
                ...
                interpretedText1.append("\n");
                interpretedText2.append("\n");
            }
        };
    }
    ...
    public void userHasLogged(String user) {
        this.frame.setTitle(("Smack Debug Window -- " + ("".equals(StringUtils.parseName(user)) ? "" : StringUtils.parseBareAddress(user)) + Separators.AT + this.connection.getServiceName() + Separators.COLON + this.connection.getPort()) + Separators.SLASH + StringUtils.parseResource(user));
    }
