...
public class AgentChatHistory extends IQ {
    ...
    public String getChildElementXML() {
        ...
        buf.append(Separators.LESS_THAN).append(ELEMENT_NAME).append(" xmlns=");
        buf.append('\"');
        buf.append("http://jivesoftware.com/protocol/workgroup");
        buf.append('\"');
        buf.append(" agentJID=\"" + this.agentJID + Separators.DOUBLE_QUOTE);
        buf.append(" maxSessions=\"" + this.maxSessions + Separators.DOUBLE_QUOTE);
        buf.append(" startDate=\"" + this.startDate + Separators.DOUBLE_QUOTE);
