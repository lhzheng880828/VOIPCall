...
public class AgentStatus implements PacketExtension {
    ...
    public static class ChatInfo {
        ...
        public String toXML() {
            ...
            if (this.userID != null) {
                buf.append(" userID=\"").append(this.userID).append(Separators.DOUBLE_QUOTE);
            }
            if (this.date != null) {
                buf.append(" startTime=\"").append(AgentStatus.UTC_FORMAT.format(this.date)).append(Separators.DOUBLE_QUOTE);
            }
            if (this.email != null) {
                buf.append(" email=\"").append(this.email).append(Separators.DOUBLE_QUOTE);
            }
            if (this.username != null) {
                buf.append(" username=\"").append(this.username).append(Separators.DOUBLE_QUOTE);
            }
            if (this.question != null) {
                buf.append(" question=\"").append(this.question).append(Separators.DOUBLE_QUOTE);
            }
            buf.append("/>");
            return buf.toString();
        }
    ...
    public String toXML() {
        StringBuilder buf = new StringBuilder();
        buf.append(Separators.LESS_THAN).append(ELEMENT_NAME).append(" xmlns=\"").append("http://jabber.org/protocol/workgroup").append(Separators.DOUBLE_QUOTE);
        if (this.workgroupJID != null) {
            buf.append(" jid=\"").append(this.workgroupJID).append(Separators.DOUBLE_QUOTE);
        }
