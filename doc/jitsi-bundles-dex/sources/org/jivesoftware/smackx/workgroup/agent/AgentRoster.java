            ...
            if (packet instanceof AgentStatusRequest) {
                for (Item item : ((AgentStatusRequest) packet).getAgents()) {
                    ...
                    if (DiscoverItems.Item.REMOVE_ACTION.equals(item.getType())) {
                        AgentRoster.this.presenceMap.remove(StringUtils.parseName(StringUtils.parseName(agentJID) + Separators.AT + StringUtils.parseServer(agentJID)));
            ...
            if (!this.listeners.contains(listener)) {
                ...
                for (String jid : getAgents()) {
                    if (this.entries.contains(jid)) {
                        ...
                        Map<String, Presence> userPresences = (Map) this.presenceMap.get(jid);
