...
public class EnhancedDebugger implements SmackDebugger {
    ...
    private void addBasicPanels() {
        ...
        table.getColumnModel().getColumn(6).setMaxWidth(Response.OK);
        ...
        sublayout.add(new JScrollPane(this.messageTextArea), "Center");
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        if (!EnhancedDebuggerWindow.PERSISTED_DEBUGGER || EnhancedDebuggerWindow.getInstance().isVisible()) {
                            int index = str.lastIndexOf(Separators.GREATER_THAN);
                            if (index != -1) {
    ...
    private void addInformationPanel() {
        ...
        jFormattedTextField = new JFormattedTextField(new SimpleDateFormat("yyyy.MM.dd hh:mm:ss:SS aaa"));
        jFormattedTextField.setMinimumSize(new Dimension(150, 20));
        jFormattedTextField.setMaximumSize(new Dimension(150, 20));
        ...
        r8 = new Object[5][];
        r8[0] = new Object[]{"IQ", Integer.valueOf(0), Integer.valueOf(0)};
        r8[1] = new Object[]{"Message", Integer.valueOf(0), Integer.valueOf(0)};
        r8[2] = new Object[]{"Presence", Integer.valueOf(0), Integer.valueOf(0)};
        r8[3] = new Object[]{"Other", Integer.valueOf(0), Integer.valueOf(0)};
        r8[4] = new Object[]{"Total", Integer.valueOf(0), Integer.valueOf(0)};
        this.statisticsTable = new DefaultTableModel(r8, new Object[]{"Type", "Received", "Sent"}) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                if (packet instanceof IQ) {
                    ...
                    messageType = "IQ Received (class=" + packet.getClass().getName() + Separators.RPAREN;
    ...
    public void addSentPacketToTable(final SimpleDateFormat dateFormatter, final Packet packet) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                if (packet instanceof IQ) {
                    packetTypeIcon = EnhancedDebugger.iqPacketIcon;
                    messageType = "IQ Sent (class=" + packet.getClass().getName() + Separators.RPAREN;
                    type = ((IQ) packet).getType().toString();
    ...
    public String formatXML(String str) {
        ...
        try {
            ...
            transformer.setOutputProperty("omit-xml-declaration", AuthorizationHeaderIms.YES);
