...
public class Bytestream extends IQ {
    ...
    public static class Activate implements PacketExtension {
        ...
        public String toXML() {
            ...
            buf.append(Separators.LESS_THAN).append(getElementName()).append(Separators.GREATER_THAN);
    ...
    public static class StreamHost implements PacketExtension {
        ...
        public String toXML() {
            StringBuilder buf = new StringBuilder();
            buf.append(Separators.LESS_THAN).append(getElementName()).append(Separators.SP);
            buf.append("jid=\"").append(getJID()).append("\" ");
            buf.append("host=\"").append(getAddress()).append("\" ");
            if (getPort() != 0) {
                buf.append("port=\"").append(getPort()).append(Separators.DOUBLE_QUOTE);
            } else {
    ...
    public String getChildElementXML() {
        ...
        if (getType().equals(Type.SET)) {
            if (getSessionID() != null) {
                buf.append(" sid=\"").append(getSessionID()).append(Separators.DOUBLE_QUOTE);
            }
            if (getMode() != null) {
                buf.append(" mode = \"").append(getMode()).append(Separators.DOUBLE_QUOTE);
            }
