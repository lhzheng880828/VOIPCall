...
public class Form {
    ...
    public void setAnswer(String variable, String value) {
        ...
        } else if (FormField.TYPE_TEXT_MULTI.equals(field.getType()) || FormField.TYPE_TEXT_PRIVATE.equals(field.getType()) || FormField.TYPE_TEXT_SINGLE.equals(field.getType()) || FormField.TYPE_JID_SINGLE.equals(field.getType()) || "hidden".equals(field.getType())) {
    ...
    public void setAnswer(String variable, int value) {
        ...
        if (field == null) {
            ...
            setAnswer(field, Integer.valueOf(value));
        } else {
    ...
    public void setAnswer(String variable, long value) {
        ...
        if (field == null) {
            ...
            setAnswer(field, Long.valueOf(value));
        } else {
    ...
    public void setAnswer(String variable, float value) {
        ...
        if (field == null) {
            ...
            setAnswer(field, Float.valueOf(value));
        } else {
    ...
    public void setAnswer(String variable, double value) {
        ...
        if (field == null) {
            ...
            setAnswer(field, Double.valueOf(value));
        } else {
    ...
    public void setAnswer(String variable, boolean value) {
        ...
        if (field == null) {
            ...
            setAnswer(field, value ? "1" : SdpConstants.RESERVED);
        } else {
    ...
    public void setAnswer(String variable, List<String> values) {
        if (isSubmitType()) {
            ...
            } else if (FormField.TYPE_JID_MULTI.equals(field.getType()) || FormField.TYPE_LIST_MULTI.equals(field.getType()) || FormField.TYPE_LIST_SINGLE.equals(field.getType()) || "hidden".equals(field.getType())) {
                field.resetValues();
    ...
    public void setInstructions(String instructions) {
        ...
        StringTokenizer st = new StringTokenizer(instructions, Separators.RETURN);
