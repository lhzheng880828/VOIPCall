...
public class FaultTolerantNegotiator extends StreamNegotiator {
    ...
    public final Packet initiateIncomingStream(Connection connection, StreamInitiation initiation) {
    ...
    public InputStream createIncomingStream(StreamInitiation initiation) throws XMPPException {
        ...
        CompletionService<InputStream> service = new ExecutorCompletionService(threadPoolExecutor);
