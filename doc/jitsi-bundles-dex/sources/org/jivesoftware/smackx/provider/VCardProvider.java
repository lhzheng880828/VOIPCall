...
public class VCardProvider implements IQProvider {
    ...
    public static VCard createVCardFromXML(String xml) throws Exception {
        ...
        new VCardReader(vCard, DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream(xml.getBytes(PREFERRED_ENCODING)))).initializeFields();
        return vCard;
    }
}
