...
public class MultipleAddresses implements PacketExtension {
    ...
    public static class Address {
        ...
        public String toXML() {
            ...
            buf.append(this.type).append(Separators.DOUBLE_QUOTE);
            if (this.jid != null) {
                buf.append(" jid=\"");
                buf.append(this.jid).append(Separators.DOUBLE_QUOTE);
            }
            if (this.node != null) {
                buf.append(" node=\"");
                buf.append(this.node).append(Separators.DOUBLE_QUOTE);
            }
            if (this.description != null && this.description.trim().length() > 0) {
                buf.append(" desc=\"");
                buf.append(this.description).append(Separators.DOUBLE_QUOTE);
            }
            if (this.delivered) {
            ...
            if (this.uri != null) {
                buf.append(" uri=\"");
                buf.append(this.uri).append(Separators.DOUBLE_QUOTE);
            }
            buf.append("/>");
            return buf.toString();
        }
