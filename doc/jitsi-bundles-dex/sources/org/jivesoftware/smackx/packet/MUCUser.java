...
public class MUCUser implements PacketExtension {
    ...
    public static class Decline {
        ...
        public String toXML() {
            ...
            buf.append("<decline ");
            if (getTo() != null) {
                buf.append(" to=\"").append(getTo()).append(Separators.DOUBLE_QUOTE);
            }
            if (getFrom() != null) {
    ...
    public static class Destroy {
        ...
        public String toXML() {
            ...
            buf.append("<destroy");
            if (getJid() != null) {
                buf.append(" jid=\"").append(getJid()).append(Separators.DOUBLE_QUOTE);
            }
            if (getReason() == null) {
                buf.append("/>");
            } else {
    ...
    public static class Item {
        ...
        public String toXML() {
            ...
            if (getAffiliation() != null) {
                buf.append(" affiliation=\"").append(getAffiliation()).append(Separators.DOUBLE_QUOTE);
            }
            if (getJid() != null) {
                buf.append(" jid=\"").append(getJid()).append(Separators.DOUBLE_QUOTE);
            }
            if (getNick() != null) {
                buf.append(" nick=\"").append(getNick()).append(Separators.DOUBLE_QUOTE);
            }
            if (getRole() != null) {
                buf.append(" role=\"").append(getRole()).append(Separators.DOUBLE_QUOTE);
            }
