...
public class VCard extends IQ {
    ...
    private static byte[] getFileBytes(java.io.File r8) throws java.io.IOException {
        /*
        r0 = 0;
        r1 = new java.io.BufferedInputStream;	 Catch:{ all -> 0x002f }
        r5 = new java.io.FileInputStream;	 Catch:{ all -> 0x002f }
        r5.<init>(r8);	 Catch:{ all -> 0x002f }
        r1.<init>(r5);	 Catch:{ all -> 0x002f }
        r6 = r8.length();	 Catch:{ all -> 0x0021 }
        r3 = (int) r6;	 Catch:{ all -> 0x0021 }
