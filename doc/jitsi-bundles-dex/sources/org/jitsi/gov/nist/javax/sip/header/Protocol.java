...
public class Protocol extends SIPObject {
    ...
    public StringBuilder encode(StringBuilder buffer) {
        buffer.append(Utils.toUpperCase(this.protocolName)).append(Separators.SLASH).append(this.protocolVersion).append(Separators.SLASH).append(this.transport.toUpperCase());
        return buffer;
    }
