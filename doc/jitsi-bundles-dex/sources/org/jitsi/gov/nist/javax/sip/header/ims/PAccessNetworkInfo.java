...
public class PAccessNetworkInfo extends ParametersHeader implements PAccessNetworkInfoHeader, ExtensionHeader {
    ...
    public StringBuilder encodeBody(StringBuilder encoding) {
        ...
        if (!this.parameters.isEmpty()) {
            encoding = this.parameters.encode(encoding.append(Separators.SEMICOLON).append(Separators.SP));
        }
        if (getExtensionAccessInfo() != null) {
            encoding.append(Separators.SEMICOLON).append(Separators.SP).append(getExtensionAccessInfo().toString());
        }
        return encoding;
    }
